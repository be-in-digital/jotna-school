      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border-2 border-amber-300 bg-amber-50 p-6 text-center">
          ...
          <button
            onClick={() => onSkip?.()}
            disabled={disabled}
            className="mt-1 rounded-2xl border-b-4 border-amber-700 bg-amber-500 px-6 py-2.5 font-game text-base font-bold text-white shadow-md transition-all duration-100 hover:bg-amber-400 active:translate-y-[2px] active:border-b-2 disabled:opacity-50"
          >
            Suivant
          </button>
        </div>
